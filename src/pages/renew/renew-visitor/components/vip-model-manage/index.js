    ...
    <div className='manage'>
      <div className='manage__content'>
        <div className='clearfix manage__content-list'>
          <div className='manage__content-left'>“谁看了你”（连续包月）</div>
          <div
      ...
      <div className='clearfix manage__panel'>
        <div className='manage__panel-interests'>
          <div className='manage__panel-img'>
            <img src={imgConfig.android} />
          </div>
          <div className='manage__panel-tips-box'>
            <p className='manage__panel-font'>智能省心</p>
            <p className='manage__panel-tip'>到期自动续费，随时可取消</p>
          </div>
        </div>
      </div>
      <Modal visible={warningVisible} className='warning' transparent maskClosable={false} title='' footer={false}>
        ...
        <div className='warningModal'>
          ...
          <div className='warningModal__title'>将无法享受“谁看了你”特权</div>
          <div
