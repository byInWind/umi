...
const list2view = (list) => (
  <>
    {list.map((item, index) => (
      <div className='user-info' key={index}>
        <div className='user-info__avatar'>
          <div className='user-info__ranking'>{index + 2}</div>
          <a
