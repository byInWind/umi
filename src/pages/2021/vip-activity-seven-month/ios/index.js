...
const App = () => {
  ...
  const shareToWechat = () => {
    ...
    let url
    if (config.version.indexOf('5.7.6') !== -1 || config.version.indexOf('5.7.4') !== -1) {
      url = 'finka2020://webview/shareToPlatform?params=' + Base64.encode(params) + '&platform=Wechat'
    } else {
      url =
  ...
  const shareToWechatMoments = () => {
    ...
    let url
    if (config.version.indexOf('5.7.6') !== -1 || config.version.indexOf('5.7.4') !== -1) {
      url = 'finka2020://webview/shareToPlatform?params=' + Base64.encode(params) + '&platform=WechatMoments'
    } else {
      url =
      ...
      <Layout>
        ...
        <div className='footer'>
          <div className='toggle_btn_box'>
            ...
            ></div>
            <img className={isShow ? 'active' : 'none'} src={imgConfig.footerStartIOSImg} />
            <img className={isShow ? 'none' : 'active'} src={imgConfig.footerClickedIosImg} />
          </div>
          <img className={isShow ? 'active' : 'none'} src={imgConfig.iosBottomImg} />
          <img className={isShow ? 'none' : 'active'} src={imgConfig.iosBottomCLickedImg} />
        </div>
